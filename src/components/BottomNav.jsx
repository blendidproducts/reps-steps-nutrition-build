        ...
        {TABS.map(({ tab, Icon, label }) => {
          ...
          return (
            <button
              ...
              className={`no-press-feedback tap-target flex flex-col items-center justify-center gap-0.5 min-w-[44px] min-h-[56px] py-2 px-2 rounded-lg transition-all active:scale-95 active:opacity-70 active:bg-[#00a9ff]/20 focus-visible:outline-2 focus-visible:outline-[#00a9ff] ${
