...
export default function Home() {
  ...
  return (
    <div style={{ backgroundColor: '#0a0a0a', minHeight: '100vh', color: '#f9fafb' }}>
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 py-12 md:py-20">
          ...
          >
            <div className="flex justify-center mb-6 md:mb-8">
              <div className="w-24 h-24 md:w-32 md:h-32 bg-gray-800/50 p-2 rounded-2xl flex items-center justify-center shadow-lg backdrop-blur-sm">
            ...
            >
              <Link to={createPageUrl("Exercises")}>
                <Button 
                  size="lg" 
                  className="gradient-bg text-white hover:opacity-90 text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 rounded-full font-bold shadow-lg hover:shadow-blue-500/30 transition-all duration-300 transform hover:scale-105 touch-manipulation"
                >
      ...
      {/* Features Section */}
      <section className="py-12 md:py-20" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-20 gradient-bg text-white relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <TrendingUp className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 md:mb-6 text-white" />
            <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 px-4">
              Ready to Transform Your Training?
            </h2>
            <p className="text-lg md:text-xl mb-8 md:mb-10 max-w-2xl mx-auto text-white/90 px-4">
            ...
            <Link to={createPageUrl("Exercises")}>
              <Button 
                size="lg" 
                className="bg-white text-black hover:bg-brand-blue hover:text-white text-lg md:text-xl px-8 md:px-12 py-4 md:py-6 rounded-full font-bold shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 touch-manipulation"
              >
                START YOUR JOURNEY
              </Button>
            </Link>
