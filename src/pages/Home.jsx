      ...
      <section style={{ backgroundColor: '#0a0a0a' }} className="text-white relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          >
            ...
            >
              <img 
                src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68c0ea2d30925fc79e7bb2af/feb2945b8_Jace_RepsandSteps_bluemodel_female1.png" 
                alt="Fitness Models"
