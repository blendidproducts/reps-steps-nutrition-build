...
const ADD_ONS = [
  ...
  },
  {
    ...
    title: "Nutrition All-Access",
    subtitle: "Everything nutrition, unlimited",
    price: "$29.99",
    period: "/mo",
    stripeUrl: "https://buy.stripe.com/YOUR_STRIPE_LINK_NUTRITION_ALL",
    features: [
      "Everything in AI Nutrition Add-On",
      "Full nutrition program library",
      "Custom meal plans",
      "All current & future nutrition features",
    ],
  },
];
...
const BUNDLES = [
  {
    ...
    title: "Pro Monthly",
    subtitle: "Full app unlock — workouts + AI features",
    price: "$9.99",
    period: "/mo",
        ...
        <section>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
            {[
              ...
              { label: "AI Fitness Brain", price: "$1.99/mo", color: "text-blue-400" },
              { label: "AI Nutrition Add-On", price: "$3.99/mo", color: "text-orange-400" },
              { label: "Nutrition All-Access", price: "$29.99/mo", color: "text-emerald-400" },
              { label: "Pro Monthly (Full Workout AI)", price: "$9.99/mo", color: "text-[#00a9ff]" },
              { label: "Pro Lifetime", price: "$199.99 once", color: "text-yellow-400" },
              { label: "Custom Coaching (1-on-1)", price: "$197/mo", color: "text-rose-400" },
            ].map((row, i, arr) => (
