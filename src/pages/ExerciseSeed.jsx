...
const SEED_EXERCISES = [
  ...
  { name: "Wall Sit",              category: "lower_body", difficulty: "intermediate", metric: "time", target_time: 45, description: "Isometric quad hold. Muscles: Quadriceps, Glutes. Cues: Knees at 90 degrees, back flat on wall, thighs parallel to floor." },
  ...
  { name: "Plank",            category: "core", difficulty: "beginner",     metric: "time", target_time: 60, description: "Isometric full-body hold. Muscles: Core, Shoulders, Glutes. Cues: Straight line head to heels, squeeze core and glutes." },
  { name: "Side Plank",       category: "core", difficulty: "intermediate", metric: "time", target_time: 30, description: "Lateral isometric hold. Muscles: Obliques, Core. Cues: Stack feet, hips elevated, straight line head to feet." },
  ...
  { name: "Hollow Body Hold", category: "core", difficulty: "advanced",     metric: "time", target_time: 30, description: "Gymnastics tension hold. Muscles: Core, Hip Flexors, Lats. Cues: Lower back pressed to floor, arms overhead, feet 6 inches up." },
  ...
  { name: "L-Sit / Pike Hold",category: "core", difficulty: "advanced",     metric: "time", target_time: 20, description: "Gymnastics hold legs parallel. Muscles: Hip Flexors, Core, Triceps. Cues: Legs parallel to ground, arms fully straight." },
  // FULL BODY
  ...
  { name: "Bar Hang / Dead Hang", category: "upper_body", difficulty: "beginner", metric: "time", target_time: 30, description: "Passive hang from a pull-up bar with full arm extension. Muscles: Grip, Lats, Shoulders, Forearms. Cues: Relax shoulders away from ears, full arm extension, breathe steadily, build grip and shoulder endurance over time." },
  ...
  { name: "Handstand Hold",  category: "upper_body", difficulty: "advanced",     metric: "time", target_time: 30, description: "Inverted bodyweight hold, typically against a wall. Muscles: Shoulders, Core, Triceps. Cues: Use the wall for support, stack hips directly over shoulders, engage the core, point the toes and hold steady." },
